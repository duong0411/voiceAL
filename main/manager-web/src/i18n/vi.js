import systemPrompts, { systemPromptPatternsVi } from './systemPrompts.vi';
...
export default {
  ...
  // Live Page
  'live.agentLabel': 'Tác nhân trò chuyện:',
  'live.selectPlaceholder': 'Chọn tác nhân AI',
  'live.loadingDevice': 'Đang tải thiết bị...',
  'live.createWebClient': 'Tạo thiết bị Web Client',
  'live.title': 'Sử dụng Micro trực tiếp trên Trình duyệt',
  'live.description': 'Vui lòng chọn hoặc cấu hình một tác nhân AI ở phía trên để bắt đầu trò chuyện trực tuyến.',
  'live.loadAgentsFailed': 'Không thể tải danh sách tác nhân AI',
  'live.loadDevicesFailed': 'Không thể lấy thông tin thiết bị',
  'live.connFailed': 'Không thể kết nối máy chủ để lấy thông tin thiết bị',
  'live.createSuccess': 'Đã tự động tạo thiết bị Web Client ảo thành công!',
  'live.createFailed': 'Không thể tạo thiết bị Web Client ảo',
  'live.connError': 'Lỗi kết nối khi tạo thiết bị ảo',
  ...
  'login.captchaRefresh': 'Nhấn để làm mới mã xác minh',
  ...
  'login.googleLoginSuccess': 'Đăng nhập bằng Google thành công!',
  'login.googleLoginFailed': 'Đăng nhập bằng Google thất bại!',
  'login.selectGoogleAccount': 'Chọn tài khoản Google để tiếp tục (Thử nghiệm)',
  'login.cancel': 'Hủy',
  ...
  'device.openWebClient': 'Mở Web Client Mic',
  ...
  dbLabels: {
    '汪汪队长': 'Đội trưởng Gâu Gâu',
    '湾湾小何': 'Tiểu Hà Đài Loan',
    '星际游子': 'Kẻ lang thang vũ trụ',
    ...
    '通义千问': 'Qwen (Alibaba)',
    '通义百炼': 'Bailian (Alibaba)',
    '百炼智能体应用': 'Ứng dụng Bailian Agent',
    '豆包大模型': 'Doubao LLM',
    '豆包语音识别': 'Doubao ASR',
    '豆包语音合成': 'Doubao TTS',
    '豆包语音识别2.0(流式)': 'Doubao ASR 2.0 (streaming)',
    '豆包语音合成2.0(流式)': 'Doubao TTS 2.0 (streaming)',
    '谷歌Gemini': 'Google Gemini',
    'Ollama本地模型': 'Ollama (local)',
    'Xinference大模型': 'Xinference LLM',
    'Xinference小模型': 'Xinference Small LLM',
    '讯飞星火认知大模型': 'iFlytek Spark LLM',
    '火山引擎边缘大模型网关': 'Volcengine AI Gateway',
    '语音活动检测': 'Phát hiện hoạt động giọng (VAD)',
    'FunASR语音识别': 'FunASR (nhận dạng giọng)',
    'Sherpa语音识别': 'Sherpa ASR',
    '腾讯语音识别': 'Tencent ASR',
    '讯飞语音识别(流式)': 'iFlytek ASR (streaming)',
    'Qwen3Flash语音识别': 'Qwen3 Flash ASR',
    'OpenAI语音识别': 'OpenAI ASR',
    'Groq语音识别': 'Groq ASR',
    'Edge语音合成': 'Edge TTS',
    '硅基流动语音合成': 'SiliconFlow TTS',
    'Coze中文语音合成': 'Coze TTS (Chinese)',
    'FishSpeech语音合成': 'FishSpeech TTS',
    'MiniMax语音合成': 'MiniMax TTS',
    '阿里云语音合成': 'Alibaba Cloud TTS',
    '302AI语音合成': '302AI TTS',
    '机智云语音合成': 'Gizwits TTS',
    'ACGN语音合成': 'ACGN TTS',
    ...
    '千问视觉模型': 'Qwen Vision',
    '无记忆': 'Không ghi nhớ',
    '本地短期记忆': 'Bộ nhớ ngắn hạn (local)',
    'Mem0AI记忆': 'Mem0AI Memory',
    '无意图识别': 'Không nhận diện ý định',
    'LLM意图识别': 'Nhận diện ý định bằng LLM',
    '外挂的大模型意图识别': 'Nhận diện ý định (LLM ngoài)',
    '大模型自主函数调用': 'Gọi hàm tự động (LLM)',
    '函数调用意图识别': 'Gọi hàm (function call)',
    'EdgeTTS女声-晓晓': 'Edge TTS — Xiaoxiao (nữ)',
    'EdgeTTS男声-云希': 'Edge TTS — Yunxi (nam)',
    'EdgeTTS女声-晓伊': 'Edge TTS — Xiaoyi (nữ)',
    'EdgeTTS女声-辽宁小贝': 'Edge TTS — Xiaobei (nữ, Liêu Ninh)',
    'EdgeTTS女声-陕西小妮': 'Edge TTS — Xiaoni (nữ, Thiểm Tây)',
    'EdgeTTS女声-香港海佳': 'Edge TTS — HiuGaai (nữ, HK)',
    'EdgeTTS女声-香港海曼': 'Edge TTS — HiuMaan (nữ, HK)',
    '通用女声': 'Giọng nữ chung',
    'CosyVoice女声': 'CosyVoice (nữ)',
  },
  dbLabelPatterns: [
    ['语音合成', 'tổng hợp giọng nói'],
    ['语音识别', 'nhận dạng giọng nói'],
    ['语音活动检测', 'phát hiện hoạt động giọng'],
    ['视觉模型', 'mô hình thị giác'],
    ['大模型', 'mô hình lớn'],
    ['小模型', 'mô hình nhỏ'],
    ['本地模型', 'mô hình local'],
    ['记忆', 'bộ nhớ'],
    ['意图识别', 'nhận diện ý định'],
    ['女声', 'giọng nữ'],
    ['男声', 'giọng nam'],
    ['御姐女声', 'giọng nữ mature'],
    ['温柔女声', 'giọng nữ dịu'],
    ['严肃女声', 'giọng nữ trầm'],
    ['粤语女声', 'giọng nữ Quảng Đông'],
    ['新闻女声', 'giọng nữ tin tức'],
    ['飒爽女声', 'giọng nữ mạnh mẽ'],
    ['童年女声', 'giọng nữ trẻ em'],
    ['成熟女声', 'giọng nữ trưởng thành'],
    ['清新女声', 'giọng nữ trong trẻo'],
    ['流畅女声', 'giọng nữ trôi chảy'],
    ['知性女声', 'giọng nữ trí tuệ'],
    ['普通话', 'tiếng Phổ thông'],
    ['中文', 'tiếng Trung'],
    ['中文及中英文混合', 'tiếng Trung & song ngữ'],
    ['粤语及粤英混合', 'tiếng Quảng Đông & song ngữ'],
    ['辽宁', 'Liêu Ninh'],
    ['陕西', 'Thiểm Tây'],
    ['粤语', 'tiếng Quảng Đông'],
    ['(流式)', '(streaming)'],
