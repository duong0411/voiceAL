...
export default {
  ...
  dbLabels: {
    ...
    '外挂的大模型意图识别': 'External LLM intent',
    '大模型自主函数调用': 'LLM function calling',
    '函数调用意图识别': 'Function-call intent',
    'EdgeTTS女声-晓晓': 'Edge TTS — Xiaoxiao (female)',
    'EdgeTTS男声-云希': 'Edge TTS — Yunxi (male)',
    'EdgeTTS女声-晓伊': 'Edge TTS — Xiaoyi (female)',
    'EdgeTTS女声-辽宁小贝': 'Edge TTS — Xiaobei (female, Liaoning)',
    'EdgeTTS女声-陕西小妮': 'Edge TTS — Xiaoni (female, Shaanxi)',
    'EdgeTTS女声-香港海佳': 'Edge TTS — HiuGaai (female, HK)',
    'EdgeTTS女声-香港海曼': 'Edge TTS — HiuMaan (female, HK)',
    '通用女声': 'Generic female voice',
    'CosyVoice女声': 'CosyVoice (female)',
  },
  dbLabelPatterns: [
    ...
    ['女声', 'female voice'],
    ['男声', 'male voice'],
    ['御姐女声', 'mature female voice'],
    ['温柔女声', 'gentle female voice'],
    ['严肃女声', 'serious female voice'],
    ['粤语女声', 'Cantonese female voice'],
    ['新闻女声', 'news female voice'],
    ['飒爽女声', 'bold female voice'],
    ['童年女声', 'child female voice'],
    ['成熟女声', 'mature female voice'],
    ['清新女声', 'fresh female voice'],
    ['流畅女声', 'smooth female voice'],
    ['知性女声', 'intellectual female voice'],
    ['普通话', 'Mandarin'],
    ['中文', 'Chinese'],
    ['中文及中英文混合', 'Chinese & bilingual'],
    ['粤语及粤英混合', 'Cantonese & bilingual'],
    ['辽宁', 'Liaoning'],
    ['陕西', 'Shaanxi'],
    ['粤语', 'Cantonese'],
    ['(流式)', '(streaming)'],
