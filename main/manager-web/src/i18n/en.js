import systemPrompts, { systemPromptPatternsEn } from './systemPrompts.en';
...
export default {
  ...
  // Live Page
  'live.agentLabel': 'Chat Agent:',
  'live.selectPlaceholder': 'Select AI Agent',
  'live.loadingDevice': 'Loading device...',
  'live.createWebClient': 'Create Web Client',
  'live.title': 'Use Microphone directly on Browser',
  'live.description': 'Please select or configure an AI agent above to start chatting online.',
  'live.loadAgentsFailed': 'Failed to load AI Agent list',
  'live.loadDevicesFailed': 'Failed to get device info',
  'live.connFailed': 'Failed to connect to server to get device info',
  'live.createSuccess': 'Virtual Web Client device created successfully!',
  'live.createFailed': 'Failed to create virtual Web Client device',
  'live.connError': 'Connection error when creating virtual device',
  ...
  'login.googleLoginSuccess': 'Successfully signed in with Google!',
  'login.googleLoginFailed': 'Google sign in failed!',
  'login.selectGoogleAccount': 'Select a Google account to continue (Testing Mode)',
  'login.cancel': 'Cancel',
  ...
  'device.openWebClient': 'Open Web Mic Client',
  ...
  dbLabels: {
    // Vietnamese keys
    'Đội trưởng Gâu Gâu': 'Captain Woof',
    'Tiểu Hà Đài Loan': 'Taiwan Girl',
    'Kẻ lang thang vũ trụ': 'Star Wanderer',
    'Giáo viên tiếng Anh': 'English Teacher',
    'Cậu bé tò mò': 'Curious Boy',
    'Tiểu Trí': 'Xiao Zhi',
    'Zhipu AI': 'Zhipu AI',
    'Zhipu Vision AI': 'Zhipu Vision AI',
    'Qwen (Alibaba)': 'Qwen (Alibaba)',
    'Bailian (Alibaba)': 'Bailian (Alibaba)',
    'Ứng dụng Bailian Agent': 'Bailian Agent App',
    'Doubao LLM': 'Doubao LLM',
    'Doubao ASR': 'Doubao ASR',
    'Doubao TTS': 'Doubao TTS',
    'Doubao ASR 2.0 (streaming)': 'Doubao ASR 2.0 (streaming)',
    'Doubao TTS 2.0 (streaming)': 'Doubao TTS 2.0 (streaming)',
    'Google Gemini': 'Google Gemini',
    'Ollama (local)': 'Ollama (local)',
    'Xinference LLM': 'Xinference LLM',
    'Xinference Small LLM': 'Xinference Small LLM',
    'iFlytek Spark LLM': 'iFlytek Spark LLM',
    'Volcengine AI Gateway': 'Volcengine AI Gateway',
    'Phát hiện hoạt động giọng (VAD)': 'Voice activity detection (VAD)',
    'FunASR (nhận dạng giọng)': 'FunASR speech recognition',
    'Sherpa ASR': 'Sherpa ASR',
    'Tencent ASR': 'Tencent ASR',
    'iFlytek ASR (streaming)': 'iFlytek ASR (streaming)',
    'Qwen3 Flash ASR': 'Qwen3 Flash ASR',
    'OpenAI ASR': 'OpenAI ASR',
    'Groq ASR': 'Groq ASR',
    'Edge TTS': 'Edge TTS',
    'SiliconFlow TTS': 'SiliconFlow TTS',
    'Coze TTS (Chinese)': 'Coze TTS (Chinese)',
    'FishSpeech TTS': 'FishSpeech TTS',
    'MiniMax TTS': 'MiniMax TTS',
    'Alibaba Cloud TTS': 'Alibaba Cloud TTS',
    '302AI TTS': '302AI TTS',
    'Gizwits TTS': 'Gizwits TTS',
    'ACGN TTS': 'ACGN TTS',
    'OpenAI TTS': 'OpenAI TTS',
    'Custom TTS': 'Custom TTS',
    'Tencent TTS': 'Tencent TTS',
    'Linkerai (streaming)': 'Linkerai (streaming)',
    'Volcengine (streaming)': 'Volcengine (streaming)',
    'Bailian (streaming)': 'Bailian (streaming)',
    'iFlytek (streaming)': 'iFlytek (streaming)',
    'Minimax (streaming)': 'Minimax (streaming)',
    'Alibaba Cloud (streaming)': 'Alibaba Cloud (streaming)',
    'PaddleSpeech (streaming)': 'PaddleSpeech (streaming)',
    'IndexTTS (streaming)': 'IndexTTS (streaming)',
    'Qwen Vision': 'Qwen Vision',
    'Không ghi nhớ': 'No memory',
    'Bộ nhớ ngắn hạn (local)': 'Local short-term memory',
    'Mem0AI Memory': 'Mem0AI memory',
    'Không nhận diện ý định': 'No intent recognition',
    'Nhận diện ý định bằng LLM': 'LLM intent recognition',
    'Nhận diện ý định (LLM ngoài)': 'External LLM intent',
    'Gọi hàm tự động (LLM)': 'LLM function calling',
    'Gọi hàm (function call)': 'Function-call intent',
    'Edge TTS — Xiaoxiao (nữ)': 'Edge TTS — Xiaoxiao (female)',
    'Edge TTS — Yunyang (nam)': 'Edge TTS — Yunyang (male)',
    'Edge TTS — Xiaoyi (nữ)': 'Edge TTS — Xiaoyi (female)',
    'Edge TTS — Yunjian (nam)': 'Edge TTS — Yunjian (male)',
    'Edge TTS — Yunxi (nam)': 'Edge TTS — Yunxi (male)',
    'Edge TTS — Yunxia (nam)': 'Edge TTS — Yunxia (male)',
    'Edge TTS — Xiaobei (nữ, Liêu Ninh)': 'Edge TTS — Xiaobei (female, Liaoning)',
    'Edge TTS — Xiaoni (nữ, Thiểm Tây)': 'Edge TTS — Xiaoni (female, Shaanxi)',
    'Edge TTS — HiuGaai (nữ, HK)': 'Edge TTS — HiuGaai (female, HK)',
    'Edge TTS — HiuMaan (nữ, HK)': 'Edge TTS — HiuMaan (female, HK)',
    'Edge TTS — WanLung (nam, HK)': 'Edge TTS — WanLung (male, HK)',
    'CosyVoice (nam)': 'CosyVoice (male)',
    'CosyVoice (nữ)': 'CosyVoice (female)',
    'Giọng nữ chung': 'Generic female voice',
  },
  dbLabelPatterns: [
    // Vietnamese patterns
    ['tổng hợp giọng nói', 'speech synthesis'],
    ['nhận dạng giọng nói', 'speech recognition'],
    ['phát hiện hoạt động giọng', 'voice activity detection'],
    ['mô hình thị giác', 'vision model'],
    ['mô hình lớn', 'large model'],
    ['mô hình nhỏ', 'small model'],
    ['mô hình local', 'local model'],
    ['bộ nhớ', 'memory'],
    ['nhận diện ý định', 'intent recognition'],
    ['giọng nữ', 'female voice'],
    ['giọng nam', 'male voice'],
    ['giọng nữ mature', 'mature female voice'],
    ['giọng nữ dịu', 'gentle female voice'],
    ['giọng nữ trầm', 'serious female voice'],
    ['giọng nữ Quảng Đông', 'Cantonese female voice'],
    ['giọng nữ tin tức', 'news female voice'],
    ['giọng nữ mạnh mẽ', 'bold female voice'],
    ['giọng nữ trẻ em', 'child female voice'],
    ['giọng nữ trưởng thành', 'mature female voice'],
    ['giọng nữ trong trẻo', 'fresh female voice'],
    ['giọng nữ trôi chảy', 'smooth female voice'],
    ['giọng nữ trí tuệ', 'intellectual female voice'],
    ['tiếng Phổ thông', 'Mandarin'],
    ['tiếng Trung', 'Chinese'],
    ['tiếng Trung & song ngữ', 'Chinese & bilingual'],
    ['tiếng Quảng Đông & song ngữ', 'Cantonese & bilingual'],
    ['Liêu Ninh', 'Liaoning'],
    ['Thiểm Tây', 'Shaanxi'],
