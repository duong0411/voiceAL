      ...
      <div class="control-panel">
        ...
        <div class="control-right" v-if="webClientDevice">
          <div class="device-badge">
            ...
            <span class="badge-text">Web Client MAC: {{ webClientDevice.macAddress }}</span>
          </div>
        </div>
  ...
  methods: {
    ...
    buildIframeUrl() {
      ...
      this.iframeUrl = `/digital-human/index.html?mac=${encodeURIComponent(mac)}&board=${encodeURIComponent(
        board
      )}&otaUrl=${encodeURIComponent(otaUrl)}&clientId=${encodeURIComponent(mac)}&lang=${currentLang}&connect=true&inputSource=browser_mic`;
    },
    generateRandomMac() {
