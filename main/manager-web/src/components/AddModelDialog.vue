<template>
  <el-dialog :visible="dialogVisible" @update:visible="handleVisibleChange" width="57%" center
    ...
    <div style="margin: 0 18px; text-align: left; padding: 10px; border-radius: 10px;">
      <div style="font-size: 30px; color: var(--val-text); margin-top: -10px; margin-bottom: 10px; text-align: center;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="font-size: 20px; font-weight: bold; color: var(--val-text);">{{ $t('modelConfigDialog.modelInfo') }}</div>
      ...
      <div style="height: 1px; background: var(--val-border); margin-bottom: 22px;"></div>
      ...
      <div style="font-size: 20px; font-weight: bold; color: var(--val-text); margin-bottom: 15px;">{{
...
.custom-dialog {
  ...
  border-radius: 20px;
  overflow: hidden;
  background: var(--val-bg-card, rgba(17, 22, 37, 0.95)) !important;
...
.custom-input-bg .el-textarea__inner:focus {
